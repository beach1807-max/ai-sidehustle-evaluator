const petFoodAnalysisReport = {
    ...
    summary: "這個點子有真實需求與付費可能，但不能做成完整推薦平台。第一版應該縮小成「飼料成分分析報告產生器」。",
    dimensions: [
        {
            name: "個人契合度",
            score: 13,
...
const aiPetMonitorReport = {
    id: "ai-pet-monitor",
    title: "AI 寵物監控摘要",
    score: 48,
    scoreLabel: "不建議直接開發",
    summary: "概念有吸引力，但第一版阻力太高。最大問題是需要串接監控器、持續讀取影像、處理雲端影片來源與使用者安裝問題，不適合一人下班時間快速驗證。",
    dimensions: [
        {
            name: "個人契合度",
            score: 10,
    ...
    oneSentenceVerdict: "不要做即時監控。第一版只做「短影片寵物行為摘要工具」，先驗證使用者是否覺得摘要有價值。",
    strengths: [
    ...
    productShape: {
        format: "一個單頁式網頁工具。使用者上傳 1～3 分鐘的寵物影片，系統產出時間點摘要與可能行為標記。",
        userFlow: [
            "Step 1：使用者上傳一段短影片",
    ...
    pricingSuggestion: "第一版可以先測單次短影片摘要收費，不建議直接做監控訂閱。",
    pricingTiers: [
        "免費版：顯示一段簡短影片摘要",
        "付費版：49～99 元，提供時間點標記與更完整觀察建議",
    ],
    validationGoal: "先確認飼主是否願意上傳短影片並為摘要付費，再考慮更完整的監控流程。",
    validationPlan: [
...
const sideProjectScorerReport = {
    id: "side-project-scorer",
    title: "副業點子冷靜評分器",
    score: 82,
    scoreLabel: "適合做 MVP",
    summary: "適合做 MVP，因為範圍小、開發快、不需要第三方資料，也符合一人副業者需求。最大風險是使用者可能覺得直接問 ChatGPT 也能做到。",
    dimensions: [
        {
            name: "個人契合度",
            score: 14,
    ...
    oneSentenceVerdict: "第一版不要做成完整 SaaS，只做「輸入表單 + 固定格式評估報告」，先驗證報告是否真的有價值感。",
    strengths: [
    ...
    productShape: {
        format: "一個純網頁評估工具。使用者輸入副業點子、可投入時間、不想做的事情後，系統產出一份結構化冷靜評估報告。",
        userFlow: [
            "Step 1：輸入副業點子",
            "Step 2：填寫可投入時間",
            "Step 3：填寫不想做的事情",
    ...
    pricingSuggestion: "第一版先驗證免費報告是否有分享與回訪，再考慮單次付費完整報告。",
    pricingTiers: [
        "免費版：顯示總分、結論與主要風險",
        "付費版：解鎖完整產品樣貌、砍掉清單與驗證行動",
    ],
    validationGoal: "先確認使用者是否覺得報告比自己問 ChatGPT 更有判斷價值。",
    validationPlan: [
