export const sampleDeepReport = {
    ...
    agentDevelopmentKit: {
        projectBrief: "建立一個讓使用者輸入副業點子後，取得冷靜評分、深度 MVP 建議與 7 天驗證計畫的單頁工具。",
        ...
        copyPasteAgentBrief: "請建立一個 React + Vite MVP 評估工具，使用現有 EvaluationInput 與 DeepReport schema，完成輸入頁、免費報告頁與 Deep Report 預覽頁，不新增登入、資料庫或金流。",
    },
    agentPromptPack: {
        buildPrompt: "請根據 DeepReport 的 agentMvpKit 與 agentDevelopmentKit 建立 MVP。優先完成可操作流程，不做登入、後台、付款或資料庫。",
        uiPrompt: "請設計一個務實、可閱讀、手機友善的 MVP 評估工具 UI。報告內容以清楚分段呈現，不使用誇大銷售語氣。",
        dataPrompt: "請依照 DeepReport schema 建立型別、範例資料與安全的 normalize 函式，缺少陣列欄位時回傳空陣列。",
        QARevisionPrompt: "請檢查 MVP 是否符合 7 天可完成範圍，移除登入、付款、社群、複雜後台與不必要資料庫。",
    },
    ...
    salesPageCopyPack: {
        ...
        heroSubtitle: "輸入你的點子，取得冷靜評估、AI Agent 開發包、推廣起手式與收費頁文案。",
        problemSection: "多數副業點子不是不能做，而是第一版做得太大、太慢、太不像驗證。",
        solutionSection: "這份報告會把點子拆成可執行的 MVP 範圍，並提供可交給 AI Agent 的開發提示。",
