...
import { buildEvaluationPrompt, type EvaluationInput } from "../lib/promptTemplate";
...
export function PromptPreviewPage() {
  ...
  const prompt = useMemo(() => buildEvaluationPrompt(input), [input]);
    ...
    <section className="mx-auto max-w-6xl px-5 py-12">
      ...
      <div className="grid gap-6 lg:grid-cols-[0.85fr_1.15fr]">
        ...
        <div className="rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex flex-wrap items-center justify-between gap-3">
            <h2 className="text-lg font-bold text-ink">Generated prompt</h2>
            <button
              type="button"
              onClick={copyPrompt}
      ...
      <section className="mt-6 rounded-lg border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <ol className="mt-4 grid gap-2 text-sm leading-7 text-slate-700 sm:grid-cols-2">
          ...
          <li>6. 貼上 JSON 並驗證</li>
          <li>7. 驗證通過後查看 generated report</li>
        </ol>
        <div className="mt-5">
